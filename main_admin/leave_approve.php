                                ...
                                <div class="card-body text-info">
                                    ...
                                    ?>
                                        ...
                                        <div class="card-footer bg-transparent border-info">
                                            <input type="submit" class="btn btn-success float-left" name="Approve" value="Approve">
                                            <input type="submit" class="btn btn-danger float-right" name="Reject" value="Reject">
