 <?php
    ...
    if (isset($_POST['submit'])) {
        ...
        if (mysqli_query($con, $updatequery)) {
            ...
            echo "<script> alert(' Shift Changed Successfully !!');</script>";
        } else {
             ...
             <div class="row">
                 ...
                 <div class="col-sm-11">
                     <div class="form-group">
                         ...
                         <input type="text" id="myInput" class="form-control" onkeyup="myFunction1()" placeholder="To check for specific employee enter employee ID">
                     </div>
                                 ...
                                 <tbody>
                                     <?php
                                        ...
                                        ?>
                                         <tr>
                                             <form action="" method="post" enctype="multipart/form-data">
                                                 <td><input type="text" class="form-control" id="myInput1" readonly name="cid" hidden value="<?php echo  "$id" ?>"><?php echo  "$id" ?></td>
